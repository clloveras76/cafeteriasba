...
<?php }else{ ?>
      <div class="container usrmn">
        <ul id="userMenu">
          <li class="regbutton"><a id="login">Ingreso / Registro </a></li>
        </ul>
      </div>
<?php } ?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar-1">
        <ul class="mainmenucentral nav navbar-nav"><li><a href="<?= \cafeterias\Core\App::urlTo('/') ?>">Home</a></li>
          ...
          <!-- li class="usermnresponsive"><button value="Ingreso / Registro" id="logi2"/></li -->
		  <li class="usermnresponsive"><a id="logi2">Ingreso / Registro</a></li>
        </ul>
      </div>
